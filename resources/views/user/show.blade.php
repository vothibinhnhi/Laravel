        ...
        <div class="row h-100 align-items-center">
            <div class="col-12 col-lg-8">
                ...
                <div class="post-content">
                    <p class="tag"><span>{{ $news->kindOfNews['name'] }}</span></p>
                    <p class="post-title">{{ $news->title }}</p>
                    <div class="d-flex align-items-center">
                        <span class="post-date mr-30">{{ date_format($news->created_at, 'F d,Y') }}</span>
                        <span class="post-date">By {{ $news->user['name'] }}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-12 col-lg-8">
                <div class="post-details-content mb-100">
                    ...
                    <img class="mb-30" src="{{ $news->thumbnail }}" width="100%" alt="">
                    <p>{{ $news->content }}.
                    </p>
                </div>
            ...
            <div class="col-12 col-sm-9 col-md-6 col-lg-4">
                <div class="sidebar-area">
                    ...
                    <div class="single-widget-area news-widget mb-30">
                        <h4>Latest News</h4>
                        @foreach ($getNews5Lasted as $item)
